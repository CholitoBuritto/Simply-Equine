...
public class RegistryHandler {
    ...
    //poles
    public static final RegistryObject<Item> BLACK_POLE = ITEMS.register("black_pole", () -> new BlockItem(ModBlocks.BLACK_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BLUE_POLE = ITEMS.register("blue_pole", () -> new BlockItem(ModBlocks.BLUE_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BROWN_POLE = ITEMS.register("brown_pole", () -> new BlockItem(ModBlocks.BROWN_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> CYAN_POLE = ITEMS.register("cyan_pole", () -> new BlockItem(ModBlocks.CYAN_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GRAY_POLE = ITEMS.register("gray_pole", () -> new BlockItem(ModBlocks.GRAY_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GREEN_POLE = ITEMS.register("green_pole", () -> new BlockItem(ModBlocks.GREEN_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_BLUE_POLE = ITEMS.register("light_blue_pole", () -> new BlockItem(ModBlocks.LIGHT_BLUE_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_GRAY_POLE = ITEMS.register("light_gray_pole", () -> new BlockItem(ModBlocks.LIGHT_GRAY_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIME_GREEN_POLE = ITEMS.register("lime_green_pole", () -> new BlockItem(ModBlocks.LIME_GREEN_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> MAGENTA_POLE = ITEMS.register("magenta_pole", () -> new BlockItem(ModBlocks.MAGENTA_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> ORANGE_POLE = ITEMS.register("orange_pole", () -> new BlockItem(ModBlocks.ORANGE_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PINK_POLE = ITEMS.register("pink_pole", () -> new BlockItem(ModBlocks.PINK_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PURPLE_POLE = ITEMS.register("purple_pole", () -> new BlockItem(ModBlocks.PURPLE_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> RED_POLE = ITEMS.register("red_pole", () -> new BlockItem(ModBlocks.RED_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> WHITE_POLE = ITEMS.register("white_pole", () -> new BlockItem(ModBlocks.WHITE_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> YELLOW_POLE = ITEMS.register("yellow_pole", () -> new BlockItem(ModBlocks.YELLOW_POLE.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));

    public static final RegistryObject<Item> BLACK_JUMP_STANDARD = ITEMS.register("black_jump_standard", () -> new BlockItem(ModBlocks.BLACK_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BLUE_JUMP_STANDARD = ITEMS.register("blue_jump_standard", () -> new BlockItem(ModBlocks.BLUE_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BROWN_JUMP_STANDARD = ITEMS.register("brown_jump_standard", () -> new BlockItem(ModBlocks.BROWN_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> CYAN_JUMP_STANDARD = ITEMS.register("cyan_jump_standard", () -> new BlockItem(ModBlocks.CYAN_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GRAY_JUMP_STANDARD = ITEMS.register("gray_jump_standard", () -> new BlockItem(ModBlocks.GRAY_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GREEN_JUMP_STANDARD = ITEMS.register("green_jump_standard", () -> new BlockItem(ModBlocks.GREEN_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_BLUE_JUMP_STANDARD = ITEMS.register("light_blue_jump_standard", () -> new BlockItem(ModBlocks.LIGHT_BLUE_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_GRAY_JUMP_STANDARD = ITEMS.register("light_gray_jump_standard", () -> new BlockItem(ModBlocks.LIGHT_GRAY_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIME_GREEN_JUMP_STANDARD = ITEMS.register("lime_green_jump_standard", () -> new BlockItem(ModBlocks.LIME_GREEN_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> MAGENTA_JUMP_STANDARD = ITEMS.register("magenta_jump_standard", () -> new BlockItem(ModBlocks.MAGENTA_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> ORANGE_JUMP_STANDARD = ITEMS.register("orange_jump_standard", () -> new BlockItem(ModBlocks.ORANGE_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PINK_JUMP_STANDARD = ITEMS.register("pink_jump_standard", () -> new BlockItem(ModBlocks.PINK_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PURPLE_JUMP_STANDARD = ITEMS.register("purple_jump_standard", () -> new BlockItem(ModBlocks.PURPLE_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> RED_JUMP_STANDARD = ITEMS.register("red_jump_standard", () -> new BlockItem(ModBlocks.RED_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> WHITE_JUMP_STANDARD = ITEMS.register("white_jump_standard", () -> new BlockItem(ModBlocks.WHITE_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> YELLOW_JUMP_STANDARD = ITEMS.register("yellow_jump_standard", () -> new BlockItem(ModBlocks.YELLOW_JUMP_STANDARD.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    ...
    public static final RegistryObject<Item> BLACK_MOUNTING_BLOCK = ITEMS.register("black_mounting_block", () -> new BlockItem(ModBlocks.BLACK_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BLUE_MOUNTING_BLOCK = ITEMS.register("blue_mounting_block", () -> new BlockItem(ModBlocks.BLUE_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> BROWN_MOUNTING_BLOCK = ITEMS.register("brown_mounting_block", () -> new BlockItem(ModBlocks.BROWN_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> CYAN_MOUNTING_BLOCK = ITEMS.register("cyan_mounting_block", () -> new BlockItem(ModBlocks.CYAN_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GRAY_MOUNTING_BLOCK = ITEMS.register("gray_mounting_block", () -> new BlockItem(ModBlocks.GRAY_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> GREEN_MOUNTING_BLOCK = ITEMS.register("green_mounting_block", () -> new BlockItem(ModBlocks.GREEN_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_BLUE_MOUNTING_BLOCK = ITEMS.register("light_blue_mounting_block", () -> new BlockItem(ModBlocks.LIGHT_BLUE_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIGHT_GRAY_MOUNTING_BLOCK = ITEMS.register("light_gray_mounting_block", () -> new BlockItem(ModBlocks.LIGHT_GRAY_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> LIME_GREEN_MOUNTING_BLOCK = ITEMS.register("lime_green_mounting_block", () -> new BlockItem(ModBlocks.LIME_GREEN_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> MAGENTA_MOUNTING_BLOCK = ITEMS.register("magenta_mounting_block", () -> new BlockItem(ModBlocks.MAGENTA_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> ORANGE_MOUNTING_BLOCK = ITEMS.register("orange_mounting_block", () -> new BlockItem(ModBlocks.ORANGE_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PINK_MOUNTING_BLOCK = ITEMS.register("pink_mounting_block", () -> new BlockItem(ModBlocks.PINK_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> PURPLE_MOUNTING_BLOCK = ITEMS.register("purple_mounting_block", () -> new BlockItem(ModBlocks.PURPLE_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> RED_MOUNTING_BLOCK = ITEMS.register("red_mounting_block", () -> new BlockItem(ModBlocks.RED_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> WHITE_MOUNTING_BLOCK = ITEMS.register("white_mounting_block", () -> new BlockItem(ModBlocks.WHITE_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
    public static final RegistryObject<Item> YELLOW_MOUNTING_BLOCK = ITEMS.register("yellow_mounting_block", () -> new BlockItem(ModBlocks.YELLOW_MOUNTING_BLOCK.get(), new Item.Properties().maxStackSize(64).group(simply_equine.EQUINE_BLOCKS)));
