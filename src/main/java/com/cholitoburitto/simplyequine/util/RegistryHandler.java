...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item>  STALL_BARS_1 = ITEMS.register("stall_bars_1", () -> makeBlockItem(ModBlocks.STALL_BARS_1));
    public static final RegistryObject<Item>  OAK_STALL_DOOR = ITEMS.register("oak_stall_door", () -> makeBlockItem(ModBlocks.OAK_STALL_DOOR));
    public static final RegistryObject<Item>  SPRUCE_STALL_DOOR = ITEMS.register("spruce_stall_door", () -> makeBlockItem(ModBlocks.SPRUCE_STALL_DOOR));
    public static final RegistryObject<Item>  ACACIA_STALL_DOOR = ITEMS.register("acacia_stall_door", () -> makeBlockItem(ModBlocks.ACACIA_STALL_DOOR));
    public static final RegistryObject<Item>  JUNGLE_STALL_DOOR = ITEMS.register("jungle_stall_door", () -> makeBlockItem(ModBlocks.JUNGLE_STALL_DOOR));
    public static final RegistryObject<Item>  BIRCH_STALL_DOOR = ITEMS.register("birch_stall_door", () -> makeBlockItem(ModBlocks.BIRCH_STALL_DOOR));
    public static final RegistryObject<Item>  DARK_OAK_STALL_DOOR = ITEMS.register("dark_oak_stall_door", () -> makeBlockItem(ModBlocks.DARK_OAK_STALL_DOOR));
