...
import com.cholitoburitto.simplyequine.config.TutorialConfig;
...
public class ShavingsBlock extends Block {
    ...
    public ShavingsBlock() {
        super(Block.Properties.create(Material.PLANTS).hardnessAndResistance(0.5F, 0.5F).sound(SoundType.PLANT));
        this.setDefaultState(this.stateContainer.getBaseState().with(LAYERS, Integer.valueOf(2)));
    }
    ...
    private boolean isEnabled() {
        return TutorialConfig.enablePowderLayers;
    }
}