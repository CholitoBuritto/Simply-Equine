...
public class ThoroughbredEntityRender extends MobRenderer<ThoroughbredEntity, ThoroughbredEntityModel<ThoroughbredEntity>> {

    protected static final ResourceLocation TEXTURE = new ResourceLocation(simply_equine.MOD_ID, "textures/entity/thoroughbred.png");
