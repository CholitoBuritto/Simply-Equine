package com.cholitoburitto.simplyequine.entities.item;
...
public class LeashKnotEntity extends HangingEntity {
    public LeashKnotEntity(EntityType<? extends net.minecraft.entity.item.LeashKnotEntity> p_i50223_1_, World p_i50223_2_) {
    ...
    public static net.minecraft.entity.item.LeashKnotEntity create(World p_213855_0_, BlockPos p_213855_1_) {
        int i = p_213855_1_.getX();
        int j = p_213855_1_.getY();
        int k = p_213855_1_.getZ();

        for(net.minecraft.entity.item.LeashKnotEntity leashknotentity : p_213855_0_.getEntitiesWithinAABB(net.minecraft.entity.item.LeashKnotEntity.class, new AxisAlignedBB((double)i - 1.0D, (double)j - 1.0D, (double)k - 1.0D, (double)i + 1.0D, (double)j + 1.0D, (double)k + 1.0D))) {
            if (leashknotentity.getHangingPosition().equals(p_213855_1_)) {
                return leashknotentity;
            }
        }

        net.minecraft.entity.item.LeashKnotEntity leashknotentity1 = new net.minecraft.entity.item.LeashKnotEntity(p_213855_0_, p_213855_1_);
